...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, gpiodriverQueueInitialize)
#endif

NTSTATUS
gpiodriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = gpiodriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = gpiodriverEvtIoStop;
